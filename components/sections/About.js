    ...
    <div className="container pt-24">
      <div className=" md:flex py-0 md:py-24">
        ...
        <div className="md:col-6 pt-14 md:pt-0">
          ...
          <h1 className=" md:leading-tight text-left text-3xl md:text-4xl font-bold text-gray-800">
            Making Your House As Good As New{' '}
          </h1>
          <div className="flex justify-start ">
            <SVG src="/svg/line.svg" className="w-36 h-6 text-black rounded-md " alt="house icon" />
          </div>
          <p className="py-8 text-base md:text-left text-gray-500">
      ...
      <div className="md:flex py-0 md:py-24">
        <div className="md:col-6 pt-14 md:pt-0">
          ...
          <p className="py-8  text-base text-left text-gray-500">
